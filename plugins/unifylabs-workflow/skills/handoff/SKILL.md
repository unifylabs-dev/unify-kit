...
- `references/addendum-phase-exec.md` — read when mode-detection returns `phasing-executor`. **Stub pointer** to `~/Projects/unify-kit/plugins/unifylabs-workflow/skills/phasing/references/checkpoint-shape.md` (the full addendum content is shared between this skill and the phasing skill; P5 of run `2026-05-24-handoff-skill-build` fills both ends).
